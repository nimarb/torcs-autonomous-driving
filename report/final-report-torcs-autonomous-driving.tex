...
\begin{figure}[ht]
	\centering
	\fbox{\rule{0pt}{2cm} \rule{1.0\linewidth}{0pt}}
	\caption{Comparison of the mean average error of different model architectures}
