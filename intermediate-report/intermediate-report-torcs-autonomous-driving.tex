...
its feasibility and performance. To explore the details of autonomous driving, an abstract prototype is build focussing on the  implementation of deriving location data from images and using sensor inputs to drive a car.
...
\begin{figure}
	\centering
	\input{attachments/alexnet-val_mae-optimiser_comp-76023-78342-79233-81479-82251.pgf}
